...
const Navbar = () => {
    ...
    return (
        <div className='flex items-center justify-between py-5 font-medium'>
            ...
            <ul className='sm:flex hidden gap-5 text-grey-700'>
            ...
            <div className="flex items-center gap-6">
                ...
                <Link to='/cart' className='relative'>
                    ...
                    <p className='absolute right-[-5px] bottom-[-5px] w-4 text-center leading-4 bg-black text-white aspect-square rounded-full text-[13px]'>{getCartCount()}</p>
                </Link>
